...
python -m inference_pipelines.dataset_conversion --input_path datasets/dataset_1 --output_path filtered_annotations/deephermes_3.jsonl --filter-file agreement_scores_rest.xlsx --filter-field text

# Step 5: Calculate inter-annotator agreement scores
# Analyzes agreement between annotations on a sample of 180 instances, excluding "non-fallacy" labels
python -m scripts.inter_annotator_scores filtered_annotations --num_samples 180 --ignore_labels "non-fallacy"
